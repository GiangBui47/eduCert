...
function resolveAddress(publicKey, network) {
    var p2wpkh = bitcoin.payments.p2wpkh({
        ...
        network: network === "mainnet" ? bitcoin.networks.bitcoin : network === "testnet" ? bitcoin.networks.testnet : network
    });
   ...
   */ function signMessage(params) {
                return _async_to_generator(function() {
                    ...
                    return _ts_generator(this, function(_state) {
                        ...
                        hash = bitcoin.crypto.hash256(bufferToHash);
...
export { BlockstreamProvider, BrowserWallet, ECPair, EmbeddedWallet, MaestroProvider, bip32, bip39, bitcoin, resolveAddress, verifySignature };
