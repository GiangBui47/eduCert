...
public class UserController {
    ...
    ApiResponse<UserResponse> updateUser(@PathVariable String userId, @RequestBody UserUpdateRoleRequest request) {
        return ApiResponse.<UserResponse>builder()
                .result(userService.updateUserRole(userId, request))
                .build();
    }
    @PutMapping("/update-information/{userId}")
    ApiResponse<UserResponse> updateUserInfomation(@PathVariable String userId, @RequestBody UserUpdateRequest request) {
        return ApiResponse.<UserResponse>builder()
